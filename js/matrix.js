...
Matrix4.prototype.multiplyArray3 = function(pos) {
	var e = this.elements;
	var p = pos;
 ...
 * @return this
 */
Matrix4.prototype.rotate_quaternino = function(p) {
	q = p.elements;
	m = this.elements;
...
Matrix4.prototype.clone = function(){
	var clone_matrix = new Matrix4();
	return clone_matrix.concat(this);
};
...
Vector3.prototype.Multiply = function(p) {
	var v = this.elements;
	v[0] *= p;
	v[1] *= p;
	v[2] *= p;
